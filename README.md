...
This repository accompanies the ENIGMA-OCD manuscript available in this preprint on MedRxiv. It contains all scripts used for multimodal data preprocessing and quality control.
